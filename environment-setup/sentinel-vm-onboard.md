...
## Next Steps
The data connectors are now establised and future compromised VM is sending logs to Sentinel. Next we must parse (/parse) the logs into structured fields for easier querying and detection rule writing.
